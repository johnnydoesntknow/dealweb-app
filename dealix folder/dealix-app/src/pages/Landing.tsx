...
export const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section with DRAMATIC LIGHT BEAMS */}
      <section className="relative pt-32 pb-24 px-6 overflow-hidden min-h-screen flex items-center">
        {/* DRAMATIC LIGHT BEAM BACKGROUND - Aurora Effect! */}
        <div className="absolute inset-0 bg-black">
          {/* Light beams shooting down from top */}
          ...
          <div className="light-beam light-beam-7"></div>
          
          {/* Top glow source */}
          <div className="absolute top-0 left-0 right-0 h-[50vh] bg-gradient-to-b from-dealix-electric-green/30 via-dealix-electric-green/10 to-transparent blur-3xl"></div>
          
          {/* Bottom darkness for contrast */}
          <div className="absolute bottom-0 left-0 right-0 h-[40vh] bg-gradient-to-t from-black via-black/80 to-transparent"></div>
          
          {/* Side shadows */}
          <div className="absolute inset-y-0 left-0 w-[30vw] bg-gradient-to-r from-black via-black/50 to-transparent"></div>
          <div className="absolute inset-y-0 right-0 w-[30vw] bg-gradient-to-l from-black via-black/50 to-transparent"></div>
        </div>
      ...
      {/* Value Props Section */}
      <section className="relative py-24 px-6 bg-gradient-to-b from-black via-[#0a1f15] to-black" id="about">
      ...
      {/* Features Section */}
      <section className="relative py-24 px-6 bg-gradient-to-b from-black via-[#0a1f15] to-black" id="features">
        <div className="relative z-10 max-w-7xl mx-auto">
      ...
      <section className="relative py-24 px-6 bg-black" id="how-it-works">
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <motion.span 
              className="inline-block px-6 py-2 bg-white/5 backdrop-blur-sm rounded-full text-gray-300 text-sm mb-8 border border-white/10"
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-black via-[#0a1f15] to-black">
        <div className="relative z-10 max-w-7xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="relative py-32 px-6 bg-gradient-to-b from-black via-[#0a1f15] to-black" id="contact">
      ...
      {/* Footer */}
      <footer className="relative border-t border-dealix-electric-green/20 py-16 px-6 bg-black">
        <div className="relative z-10 max-w-7xl mx-auto">
